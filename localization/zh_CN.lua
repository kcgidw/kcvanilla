-- 翻译声明：大部分译文来自 Discard: @broookling ，有少量修订
return {
    descriptions = {
        Joker = {
            j_kcvanilla_5day = {
            ...
            j_kcvanilla_tenpin = {
                ...
                text = {
                    ...
                    '则接下来2次出牌中{X:mult,C:white} X2 {}倍率',
                    '{C:inactive}（#1#）{}'
                }
            },
            j_kcvanilla_rakugo = {
                name = "落语艺人",
                text = {
                    '若打出的手牌包含{C:attention}顺子{}，',
                    '则重新触发每张打出的{C:attention}4{}、{C:attention}5{}、{C:attention}6{}、{C:attention}7{}和{C:attention}8{}'
                }
            },
            j_kcvanilla_rats = {
                name = "耗子！",
