    ...
    descriptions = {
        Joker = {
            ...
            j_kcvanilla_guard = {
                ...
                text = {
                    "If played hand has ",
                    "no {C:attention}Kings{} and {C:attention}Queens{},",
                    "{C:chips}+#1#{} Chips for each",
                    "{C:attention}King{} or {C:attention}Queen{} in",
            ...
            j_kcvanilla_handy = {
                ...
                text = {
                    ...
                    'this gains {X:mult,C:white} X1 {} Mult, resets',
            ...
            j_kcvanilla_rakugo = {
                ...
                text = {
                    ...
                    'is skipped, open',
                    'another {C:attention}Booster Pack{}',
                    'of the same kind,',
                    'once between {C:attention}Blinds{}',
                    '{C:inactive}(#1#)'
                }
            },
